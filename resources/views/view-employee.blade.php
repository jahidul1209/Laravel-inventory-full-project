            ...
            <div class="col-sm-12">
               <div class="panel panel-default">
                    <div class="panel-heading">
						...
						<a href="{{route('all-employee')}}" class = "btn btn-sm btn-default pull-right">All Employee</a>
                        ...
                        <div class="row">
                          <div class="col-md-1"></div>
                            <div class="col-md-7 col-sm-12 col-xs-12">
									...
									<h3>Salary : <span style="font-weight: 400 ; font-size: 20px">{{$view->salary}}</span></h3>
									<h3>Experience : <span style="font-weight: 400 ; font-size: 20px">{{$view->experience}}</span></h3>
									<h3>Vacation : <span style="font-weight: 400 ; font-size: 20px">{{$view->vacation}}</span></h3>
