            ...
            <div class="col-sm-12">
               <div class="panel panel-default">
                    <div class="panel-heading">
						...
						<a href="{{route('all-supplier')}}" class = "btn btn-sm btn-default pull-right">All Supplier</a>
                        ...
                        <div class="row">
                          <div class="col-md-1"></div>
                            <div class="col-md-7 col-sm-12 col-xs-12">
									...
									<h3>Shop Name: <span style="font-weight: 400 ; font-size: 20px">{{$view->Shop}}</span></h3>
									<h3>Supplier Type : <span style="font-weight: 400 ; font-size: 20px">{{$view->type}}</span></h3>
